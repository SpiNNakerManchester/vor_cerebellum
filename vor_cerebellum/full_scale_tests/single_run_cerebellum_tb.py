...
from vor_cerebellum.utilities import (
    sensorial_activity, error_activity, process_VN_spiketrains, get_plot_order,
...
MF_population = sim.Population(
    ...
    {'rate': sensorial_activity(_head_pos[0], _head_vel[0])[0]},
    label="MF",
    additional_parameters={'seed': 24534, 'max_rate': MAX_RATE})
...
# error activity, but we skip it and just generate an error from -1.5 to 1.5)
