...
for i in range(5):
    input_spike_times[i * 2] = [
        250 + (10 * 2 * i) for _ in range(1)]
    input_spike_times[2 * i + 1] = [
        500 + (10 * (2 * i + 1)) for _ in range(1)]
    input_spike_times[50 + i * 2] = [
        750 + (10 * 2 * i) for _ in range(10 + i)]
